...
export default function GameScreen() {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden select-none touch-none bg-[#f0f4f8] font-sans">
      ...
      <GameHud gameState={gameState} health={health} maxHealth={maxHealth} money={money} formattedTime={formattedTime} currentWave={currentWave} />
      <StatusBanner waveMsg={waveMsg} />
      <BuildBar gameState={gameState} money={money} dragTowerId={dragTowerId} beginTowerDrag={beginTowerDrag} towerTypes={towerTypes} setBuildBarRect={setBuildBarRect} />
