...
*   **Gameplay Hook (`src/logic/hooks/useGeoGuardGame.jsx`)**:
    *   Now delegates scene drawing to `drawGameScene()` and keeps runtime orchestration, wave flow, reward UI presentation handoff, remaining debug wave/UI orchestration, and Boss behavior scheduling.
