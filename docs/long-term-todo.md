...
- Continue splitting `src/logic/hooks/useGeoGuardGame.jsx` into narrower runtime modules, especially combat update flow and authored encounter orchestration.
