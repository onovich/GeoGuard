...
- Continue splitting `src/logic/hooks/useGeoGuardGame.jsx` into narrower runtime modules, especially remaining small editor spawn bridge callbacks or drag placement commit handling.
