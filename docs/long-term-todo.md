...
- Continue splitting `src/logic/hooks/useGeoGuardGame.jsx` into narrower runtime modules, especially remaining wave spawn side effects, boss scheduling, and debug panel bridges.
