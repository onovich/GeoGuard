...
- Continue splitting `src/logic/hooks/useGeoGuardGame.jsx` into narrower runtime modules, especially enemy death/reward orchestration and authored encounter orchestration.
