...
- Continue splitting `src/logic/hooks/useGeoGuardGame.jsx` into narrower runtime modules, especially remaining wave entity creation side effects, boss scheduling, and debug panel bridges.
