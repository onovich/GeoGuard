...
- Continue splitting `src/logic/hooks/useGeoGuardGame.jsx` into narrower runtime modules, especially authored encounter orchestration and remaining debug/runtime wiring.
