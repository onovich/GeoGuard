...
- Continue splitting `src/logic/hooks/useGeoGuardGame.jsx` into narrower runtime modules, especially remaining wave orchestration, boss scheduling, and debug panel bridges.
