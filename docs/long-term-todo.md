...
- Continue splitting `src/logic/hooks/useGeoGuardGame.jsx` into narrower runtime modules, especially remaining debug wave UI wiring and small editor or drag bridge callbacks.
