...
Owns wave-start runtime helpers for creating authored wave state, applying debug Boss authoring to wave bosses, and building wave overview/message presentation state.
