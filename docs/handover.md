...
Owns debug combat-field clearing, sandbox wave reset, sandbox overview metadata, debug action presentation helpers, debug panel UI reset plans, debug reward panel state, and debug option side effects for infinite money or health.
