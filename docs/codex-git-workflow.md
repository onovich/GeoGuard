...
<!-- initialized-at: 2026-06-09 22:17:49 +08:00 -->
...
```
powershell
git -c safe.directory=D:/WebProjects/GeoGuard status --short --branch
```
...
```
powershell
git -c safe.directory=D:/WebProjects/GeoGuard push -u origin HEAD
```
